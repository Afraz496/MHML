...
public class FdActivity extends Activity implements CvCameraViewListener2 {
   ...
   // private MenuItem               mItemType;
    ...
    // Boolean, true when user is looking to paper
    private boolean lookingDown = true;
    private boolean userThere = false;
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if(ext_matchLoc!=null && ext_eyes_only_rect!=null){
            ...
            Imgproc.putText(mRgba, "eye area"+eye_area+"match Location "+ match,
            new Point(500, 500),
            Core.FONT_HERSHEY_SIMPLEX, 0.7, new Scalar(255, 255, 255,
            255));
        ...
        }else if(userThere && lookingDown){
            mstate=State.PAYING_ATTENTION;
        }else{
            mstate=State.NOT_PAYING_ATTENTION;
        }

        Imgproc.putText(mRgba, mstate.toString(), new Point(100,200), 0,
                3.0, new Scalar(255,0,0,255), 4 );
