...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
  ...
  private enum DetectorMode {
    TF_OD_API, MULTIBOX, YOLO, FACE;
  }
  private static final DetectorMode MODE = DetectorMode.FACE;

  // Minimum detection confidence to track a detection.
  private static final float MINIMUM_CONFIDENCE_TF_OD_API = 0.6f;
  private static final float MINIMUM_CONFIDENCE_MULTIBOX = 0.1f;
  private static final float MINIMUM_CONFIDENCE_YOLO = 0.25f;
  private static final float MINIMUM_CONFIDENCE_FACE = 0.5f;
  ...
  public void onPreviewSizeChosen(final Size size, final int rotation) {
    ...
    else if (MODE == DetectorMode.FACE) {
      try {
        detector = TensorFlowObjectDetectionAPIModel.create(
                getAssets(), FACE_DETECTION_MODEL_FILE, FACE_DETECTION_LABELS_FILE, FACE_DETECTION_INPUT_SIZE);
